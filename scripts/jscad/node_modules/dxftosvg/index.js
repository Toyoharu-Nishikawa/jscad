...
const getColorLineTypeSvg = (color, lineTypeName) => {
...
const getSvgSnippet = (type, param) => {
  switch (type) {
    case 'line': {
      ...
      const lineTypeName = param.lineTypeName
    ...
    case 'circle': {
      ...
      const tmpColorLineType  =getColorLineTypeSvg(color, lineType)
      const tmpEnd = "/>\n"
    ...
    case 'polyline': {
      ...
      for (let i=0; i<vertices.length-1; i++) {
        ...
        svgSnippet += getLineSvg(vertice1.x, vertice1.y, vertice2.x, vertice2.y, color, lineTypeName)
      }
      return svgSnippet
    }
    case 'bspline': {
...
const dxfToObj = dxfObject => {
  ...
  switch (dxfObject.type) {
    case 'LINE': {
      const param = {type: "line", points: [ [dxfObject.x, dxfObject.y], [dxfObject.x1, dxfObject.y1] ], color: dxfObject.color, lineTypeName: dxfObject.lineTypeName  }
      return param 
    }
    case 'CIRCLE': {
      const param = {type: "circle", center: [dxfObject.x, dxfObject.y], radius: dxfObject.r, color: dxfObject.color, lineTypeName: dxfObject.lineTypeName   }
      return param 
    }
    case 'ARC': {
      const param = {type: "arc", center: [dxfObject.x, dxfObject.y], radius: dxfObject.r, start:dxfObject.a0, end: dxfObject.a1, color: dxfObject.color, lineTypeName: dxfObject.lineTypeName    }
      return param 
    }
    case 'LWPOLYLINE': {
      ...
      const param = {type: "polyline", points: points, color: dxfObject.color, lineTypeName: dxfObject.lineTypeName  }
      return param 
    }
    case 'SPLINE': {
      const vertices = dxfObject.vertices;
      ...
      const param = {type: "bspline", points: points, knots: knots, degree: degree, color: dxfObject.color, lineTypeName: dxfObject.lineTypeName  }
