...
import { Svg, on, off, extend, Matrix, Box } from '../../svg.js/src/main.js'
...
extend(Svg, {
  panZoom (options) {
    ...
    options = options || {}
    const zoomMode = options.zoomMode || "exponential" 
    ...
    var wheelZoom = function (ev) {
      ...
      let lvl = zoomMode === "exponential" ? this.zoom() * Math.pow(zoomFactor,  -ev.deltaY/Math.abs(ev.deltaY)):
        this.zoom() - zoomFactor * ev.deltaY / Math.abs(ev.deltaY)
